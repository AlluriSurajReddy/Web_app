<%-- 
    Document   : logfac
    Created on : Jun 28, 2019, 4:36:18 PM
    Author     : admin
--%>
...
<!-- / END -->
    ...
    <body>
        <form action="logerfac.jsp" method="post" name="form">
        <center>
            <H6 ALIGN="RIGHT"><a href="project.css3prj.html">back</a></H6>
            <H6 ALIGN="RIGHT"><a href="facultyreg.jsp">New Registration</a></H6>
      <a href="home.jsp"><H1 ALIGN="CENTER"></H1></a>
      
           <h3 align="center">FACULTY LOGIN PAGE </h3>
           <body bgcolor="white">     
        
                 <table> <tr><td>userid:</td>
                 <td> <input type="text" name="userid" value=""></td><br></tr>
        <tr><td> password: </td>
