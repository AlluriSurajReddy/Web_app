<%-- 
    Document   : stchangepas
    Created on : Jun 28, 2019, 5:34:23 PM
    Author     : admin
--%>
...
<!-- / END -->
    ...
    <body>
        <center><h1><span class="highlight">Hawkins</span> Middle School.</h1></CENTER>
             <h6 align="right"><a href="student_home.css3prj.html">go back</a></h6> 
     <a href=""><H1 ALIGN="CENTER"></H1></a>
        <H3 ALIGN="CENTER">CHANGE STUDENT PASSWORD </H3>
...
<form name="ChangePasswordForm" method="post" action="stpas.jsp" OnSubmit="return fncSubmit();">
